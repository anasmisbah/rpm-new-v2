    ...
    <div class="col-md-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Mengubah Agen</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{route('agen.update',$agen->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input type="text" value="{{old('no_agen')?old('no_agen'):$agen->no_agen}}" class="form-control @error('no_agen') is-invalid @enderror" id="no_agen" name="no_agen" placeholder="no agen">
                                @error('no_agen')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input type="text" value="{{old('name')?old('name'):$agen->name}}" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="name">
                                @error('name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input type="text" value="{{old('address')?old('address'):$agen->address}}" class="form-control @error('address') is-invalid @enderror" id="address" name="address" placeholder="address">
                                @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input type="text" value="{{old('phone')?old('phone'):$agen->phone}}" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" placeholder="phone">
                                @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input type="text" value="{{old('npwp')?old('npwp'):$agen->npwp}}" class="form-control @error('npwp') is-invalid @enderror" id="npwp" name="npwp" placeholder="npwp">
                                @error('npwp')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input type="text" value="{{old('website')?old('website'):$agen->website}}" class="form-control @error('website') is-invalid @enderror" id="website" name="website" placeholder="website">
                                @error('website')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input value="{{old('email_user')?old('email_user'):$agen->user->email}}" type="email" class="form-control @error('email_user') is-invalid @enderror" id="email_user" name="email_user" placeholder="email_user">
                                @error('email_user')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
