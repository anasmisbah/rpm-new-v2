    ...
    <div class="col-md-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Menambah Customer Agen {{ $agen->name }}</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{route('customer.agen.store',$agen->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
